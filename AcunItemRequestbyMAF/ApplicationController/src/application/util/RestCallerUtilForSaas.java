...
public class RestCallerUtilForSaas {
    public RestCallerUtilForSaas() {
        super();
    }
    ...
    private String invokeRestRequest(String httpMethod, String requestURI, String payload) {
        ...
        restServiceAdapter.setConnectionName("RESTSaaSConn");
        ...
        //For basic authenticatio
        String encoding;
        try {
            encoding = Base64.getEncoder().encodeToString(("BAYRAME:159753_b").getBytes("UTF-8"));
